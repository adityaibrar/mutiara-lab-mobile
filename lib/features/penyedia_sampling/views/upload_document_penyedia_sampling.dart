...
class UploadDocumentPenyediaSampling extends StatefulWidget {
  static const String routeName = '/upload-document-penyedia-sampling';
  const UploadDocumentPenyediaSampling({super.key});

  @override
  State<UploadDocumentPenyediaSampling> createState() =>
      _UploadDocumentPenyediaSamplingState();
}

class _UploadDocumentPenyediaSamplingState
    extends State<UploadDocumentPenyediaSampling> {
  late final int? id;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Consumer2<ImageNotifier, PenyediaSamplingNotifier>(
            builder: (context, imageNotifier, penyediaSamplingNotifier, child) {
