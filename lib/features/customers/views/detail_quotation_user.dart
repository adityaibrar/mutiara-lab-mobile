...
import 'upload_document_invoice.dart';

class DetailQuotationUser extends StatelessWidget {
  static const String routeName = '/detail-quotation-user-page';
  const DetailQuotationUser({super.key});

  @override
  Widget build(BuildContext context) {
    final doc = ModalRoute.of(context)!.settings.arguments as ListInvoiceModel;
    return Scaffold(
