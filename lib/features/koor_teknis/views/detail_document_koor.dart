...
import 'upload_document_koor.dart';

class DetailDocumentKoor extends StatelessWidget {
  static const String routeName = '/detail-document-koor-teknis-page';
  const DetailDocumentKoor({super.key});

  @override
  Widget build(BuildContext context) {
    final doc = ModalRoute.of(context)!.settings.arguments as MarketingDocument;
    return Scaffold(
